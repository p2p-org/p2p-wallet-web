...
export class SendService implements SendServiceType {
  ...
  constructor({
    ...
    feeRelayerAPIClient,
    relayService,
    renVMBurnAndReleaseService,
    feeService,
    walletsRepository,
  }: {
    relayMethod: RelayMethod;
    solanaSDK: SolanaSDKClass;
    orcaSwap: OrcaSwap.OrcaSwapType;
    feeRelayerAPIClient: FeeRelayerAPIClientType;
    relayService: FeeRelayer.Relay.FeeRelayerRelayType;
    ...
    this._walletsRepository = walletsRepository;
  }
