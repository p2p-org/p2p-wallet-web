...
import type { PoolsPair } from 'app/sdk/OrcaSwap/models/OrcaSwapPools';
...
export class RelayTransactionParam {
  ...
  constructor(preparedTransaction: SolanaSDK.PreparedTransaction) {
    ...
    this.instructions = message.instructions.map((compiledInstruction) => {
...
export class SwapTransactionSignatures {
  ...
  transferAuthoritySignature?: string;
