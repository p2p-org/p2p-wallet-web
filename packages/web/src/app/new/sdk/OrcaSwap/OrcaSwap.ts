/* eslint-disable @typescript-eslint/no-non-null-assertion,@typescript-eslint/no-magic-numbers,no-console */
...
import { toLamport } from 'app/new/sdk/SolanaSDK/extensions/NumberExtensions';
import { SolanaSDKPublicKey } from 'app/new/sdk/SolanaSDK/extensions/PublicKey/PublicKeyExtensions';
...
export class OrcaSwap implements OrcaSwapType {
  ...
  load(): Promise<void> {
    ...
    console.debug('Orca swap info loaded');
