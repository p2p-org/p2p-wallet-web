...
import type { FeeRelayerAPIClientType } from 'app/new/sdk/FeeRelayer';
import * as FeeRelayer from 'app/new/sdk/FeeRelayer';
...
import type { SolanaSDK as SolanaSDKClass } from 'app/new/sdk/SolanaSDK';
import * as SolanaSDK from 'app/new/sdk/SolanaSDK';
import { SolanaSDKError, SolanaSDKPublicKey, toLamport } from 'app/new/sdk/SolanaSDK';
...
export class SendService implements SendServiceType {
  ...
  private _solanaSDK: SolanaSDKClass;
  ...
  private _feeService: FeeServiceType;
  ...
  constructor(relayMethod: RelayMethod) {
