...
import type { SwapDirectParams } from './direct';
import { SwapDirect } from './direct';
import type { SwapTransitiveParams } from './transitive';
import { SwapTransitive } from './transitive';
