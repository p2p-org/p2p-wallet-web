...
import type { SwapDirect } from './factory/direct/direct';
import type { SwapTransitive } from './factory/transitive/transitive';
import { IDL } from './idl';
...
export class Swap {
  ...
  estimate() {
    ...
    const estimatedFee = this._userSwap.estimate();
