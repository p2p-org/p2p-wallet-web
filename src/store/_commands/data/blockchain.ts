...
export const getPoolsProgramAccountsAsyncAction = createAsyncAction(
  'SOLANA_GET_POOLS_PROGRAM_ACCOUNTS_REQUEST',
  'SOLANA_GET_POOLS_PROGRAM_ACCOUNTS_SUCCESS',
  'SOLANA_GET_POOLS_PROGRAM_ACCOUNTS_FAILURE',
  'SOLANA_GET_POOLS_PROGRAM_ACCOUNTS_CANCEL',
)<undefined, Array<web3.PublicKeyAndAccount<Buffer | web3.ParsedAccountData>>, Error>();
